...
if __name__ == "__main__":
    ...
    with computer:
        ...
        with console.status("[bold green]Navigating to the hackathon website...[/bold green]", spinner="dots"):
        ...
        with console.status("[bold green]Starting MCP server...[/bold green]", spinner="dots"):
        ...
        console.print(Panel("[bold yellow]Computer is running[/bold yellow]\nPress Ctrl+C to shutdown", 
                           border_style="yellow"))
    ...
    console.print("[green]✓[/green] [bold green]Computer successfully shut down[/bold green]")
