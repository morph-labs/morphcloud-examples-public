...
if "MORPH_API_KEY" not in os.environ:
    console.print("[bold red]ERROR: You must set the MORPH_API_KEY environment variable[/bold red]")
...
async def test_quickstart():
    ...
    console.print(Panel("Testing Quickstart Example", title="Example: Quickstart", border_style="blue"))
...
async def test_sandbox_creation():
    ...
    console.print(Panel("Testing Example: Create and manage a sandbox", border_style="blue"))
...
"""
                ...
                print(f"Downloaded file exists: {os.path.exists(f'{temp_dir}/results.csv')}")
                ...
                print(f"Downloaded directory exists: {os.path.exists(f'{temp_dir}/local_output')}")
                if os.path.exists(f"{temp_dir}/local_output"):
                    print(f"Files in downloaded directory: {os.listdir(f'{temp_dir}/local_output')}")
...
async def test_snapshots():
    ...
    console.print(Panel("Testing Example: Create and restore snapshots", border_style="blue"))
...
async def test_claude_integration():
    ...
    console.print(Panel("Testing Example: Integrate with Anthropic's Claude API", border_style="blue"))
    
    # Check if ANTHROPIC_API_KEY is set
    if "ANTHROPIC_API_KEY" not in os.environ:
        console.print("[yellow]⚠️ ANTHROPIC_API_KEY not set, skipping Claude integration test[/yellow]")
        console.print("To run this test, set the ANTHROPIC_API_KEY environment variable")
...
async def test_simple_plot():
    ...
    console.print(Panel("Testing Example: Create and display plots", border_style="blue"))
...
plt.show()
            ...
            if "images" in result:
                ...
                console.print(f"[green]✅ Successfully captured {len(images)} images![/green]")
...
async def run_all_tests():
    ...
    console.print(Panel("Morph Sandbox Demo Script - Testing all Quick Examples", border_style="green"))
